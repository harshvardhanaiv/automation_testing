...
//   await page.getByRole('gridcell', { name: 'Select row ' }).locator('div').click();
//   await page.locator('tr').filter({ hasText: 'Customers detailsPath :: /Report/pdfAdmin2025-01-30 09:49:' }).locator('span').first().click();
//   await page.locator('a').filter({ hasText: 'Delete' }).click();
//   await page.getByRole('checkbox', { name: 'All versions' }).check();
//   await page.getByRole('button', { name: 'Delete' }).click();
//   await page.locator('td').filter({ hasText: 'Customers detailsPath :: /Output/Temp/' }).locator('i').nth(1).click();
...
//   await page.getByRole('button', { name: 'Delete' }).click();
  ...
  await page.locator('[id="rp_Customer\\ Name"]').fill('103');
  // await page.waitForTimeout(2000);
...
await page.getByRole('textbox', { name: 'Enter Name' }).fill('Right Now Customer Details');
// await page.waitForTimeout(2000);
...
// await page.getByRole('listitem').filter({ hasText: 'Waiting For Event' }).click();
// await page.waitForTimeout(2000);

// await page.getByRole('link', { name: 'Running' }).click();
// await page.waitForTimeout(2000);

await page.getByRole('listitem').filter({ hasText: 'Completed' }).click();
// await page.waitForTimeout(2000);

await page.getByRole('gridcell', { name: 'Right Now Customer Details' }).click();
// await page.waitForTimeout(2000);
...
await page.locator('div').filter({ hasText: /^Right Now$/ }).locator('span').click();
// await page.waitForTimeout(2000);
...
await page.getByRole('button', { name: 'Run Jobs' }).click();
// await page.waitForTimeout(2000);

await page.getByRole('row', { name: 'Select row REPORTEXECUTION is' }).locator('span').first().click();
await page.waitForTimeout(2000);

await page.getByRole('link', { name: ' Re-execute' }).click();
await page.waitForTimeout(2000);
