...
test.describe('AIV Login and Create MySQL', () => {
  test('Login, Navigate, and Create MySQL', async ({ page }, testInfo) => {
    ...
    const BASE_URL = "http://localhost:8080/aiv/"; // Hardcoded base URL
    const USERNAME = "Admin"; // Hardcoded username
    const PASSWORD = "password"; // Hardcoded password
    const DEMO_USERNAME = "Demo"; // Hardcoded demo username
    const DEMO_PASSWORD = "password"; // Hardcoded demo password
