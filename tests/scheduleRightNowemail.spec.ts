...
// await page.waitForTimeout(2000);
  ...
  await page.locator('p-checkbox').filter({ hasText: 'Export Report' }).locator('div').nth(2).click();
  await page.waitForTimeout(2000);

  await page.getByText('Users').nth(3).click();
  await page.waitForTimeout(2000);

  await page.getByLabel('Demo', { exact: true }).getByText('Demo').click();
  await page.waitForTimeout(2000);
  ...
  await page.getByRole('option', { name: 'label_first' }).click({ timeout: 5000 });
  await page.locator('#pr_id_13_label').click({ timeout: 5000 });
  await page.getByLabel('5 mins', { exact: true }).getByText('mins').click({ timeout: 5000 });
